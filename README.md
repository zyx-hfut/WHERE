...
当前版本：`v0.15.0-graph-updater`。桌面端备份支持用户选择保存位置，并已接入签名校验的在线更新框架和轻量知识图谱。

Android 开发环境和 PC 调试步骤见 [docs/ANDROID_DEV.md](docs/ANDROID_DEV.md)。
...
- “知识图谱”页面按列表展示物品与位置节点，用关系边直观表达“物品—位置”关系，不依赖第三方图形库。
